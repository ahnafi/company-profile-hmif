...
export default function HeroSection() {
    return (
        <section
            id="hero"
            className="section-padding-x relative scroll-mt-12 bg-light-base bg-[url('/img/backgrounds/kabinet-arditasena.png')] bg-cover bg-center pt-32 pb-16 text-dark-base lg:pt-32 dark:bg-slate-950 dark:text-light-base bg-fixed"
        >
            ...
            <div className="relative mx-auto flex max-w-screen-xl flex-row justify-between gap-4">
                <motion.div
                ...
                >
                    <div className="mb-4 rounded-lg text-dark-base dark:text-light-base">
                        ...
                        <motion.h1
                            className="mb-2 font-bold md:text-left"
                        ...
                        >
                            Bergabunglah bersama kami di <span className="bg-blue-imphnen-base text-light-base">HMIF Unsoed</span>, wadah pengembangan
                    ...
                    <motion.div
                        className="flex flex-col gap-4 md:flex-row xl:justify-between"
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.9, duration: 0.6 }}
                    >
                        <div className="flex items-center justify-between gap-8 rounded-lg p-4 text-center text-dark-base dark:text-light-base">
                ...
                <div className="relative hidden w-5xl lg:block">
                    <img src="/img/logos/hmif.png" alt="Logo HMIF Unsoed" className="absolute top-0 left-0 w-20 md:w-32 xl:w-48" />
                    <img src="/img/logos/kabinet.png" alt="Logo Kabinet HMIF Unsoed" className="absolute right-0 bottom-0 w-16 md:w-28 xl:w-40" />
                </div>
            </div>
        </section>
    );
