...
use App\Filament\Finance\Resources\MikatCashResource\Pages;
use App\Filament\Finance\Resources\MikatCashResource\RelationManagers;
...
class MikatCashResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Kas Mikat';
